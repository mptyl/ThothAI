...
class WorkspaceSerializer(serializers.ModelSerializer):
    ...
    sql_db = SqlDbSerializer(allow_null=True, required=False)
    default_workspace = serializers.PrimaryKeyRelatedField(many=True, read_only=True)
    default_model = AiModelSerializer(allow_null=True, required=False)
    question_validator = AgentSerializer(allow_null=True, required=False)
    kw_sel_agent = AgentSerializer(allow_null=True, required=False)
    sql_basic_agent = AgentSerializer(allow_null=True, required=False)
    sql_advanced_agent = AgentSerializer(allow_null=True, required=False)
    sql_expert_agent = AgentSerializer(allow_null=True, required=False)
    test_gen_agent_1 = AgentSerializer(allow_null=True, required=False)
    test_gen_agent_2 = AgentSerializer(allow_null=True, required=False)
    test_gen_agent_3 = AgentSerializer(allow_null=True, required=False)
    test_evaluator_agent = AgentSerializer(allow_null=True, required=False)
    explain_sql_agent = AgentSerializer(allow_null=True, required=False)
    ask_human_help_agent = AgentSerializer(allow_null=True, required=False)
    setting = SettingSerializer(allow_null=True, required=False)
