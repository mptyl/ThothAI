...
urlpatterns = [
    ...
    path("api/supabase-auth", views.supabase_auth, name="supabase_auth"),
    ...
    path(
        "api/workspace/id/<int:workspace_id>",
        views.get_workspace_by_id,
        name="get_workspace_by_id",
    ),
    path(
        "api/workspace/<int:workspace_id>/agent-pools/",
        views.get_workspace_agent_pools,
        name="get_workspace_agent_pools",
    ),
    path(
        "api/workspace/<int:workspace_id>/check-embedding/",
        views.check_embedding_config,
        name="check-embedding-config",
    ),
    path(
        "api/workspace/<int:workspace_id>/test-vector-db/",
        views.test_vector_db_connection,
        name="test-vector-db-connection",
    ),
    path(
        "api/sqldb/<str:db_name>/tables/",
        views.TableListByDbNameView.as_view(),
        name="table-list-by-db-name",
    ),
    path(
        "api/sqldb/<str:db_name>/table/<str:table_name>/columns/",
        TableColumnsDetailView.as_view(),
        name="table-columns-detail",
    ),
    ...
    path(
        "ajax/admin/tables/",
        views.get_tables_by_database,
        name="get_tables_by_database",
    ),
    path(
        "ajax/admin/columns/", views.get_columns_by_table, name="get_columns_by_columns"
    ),
    ...
    path(
        "api/thoth-logs/", ThothLogListCreateView.as_view(), name="thothlog-list-create"
    ),
    path(
        "api/thoth-logs/<int:pk>/", ThothLogDetailView.as_view(), name="thothlog-detail"
    ),
    path(
        "api/thoth-logs/summary/", views.get_thoth_logs_summary, name="thothlog-summary"
    ),
