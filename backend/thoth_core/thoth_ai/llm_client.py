...
class ThothLLMClient:
    ...
    def __init__(self, ai_model):
        ...
        logger.info(f"Initialized LLM client for {self.provider} with model {self.model_name}")
    ...
    def _get_model_name(self) -> str:
        ...
        if self.provider in [LLMChoices.CODESTRAL, LLMChoices.DEEPSEEK, LLMChoices.LMSTUDIO]:
    ...
    def generate(
        ...
        **kwargs
        ...
        if self.provider in [LLMChoices.OLLAMA, LLMChoices.LLAMA]:
            completion_args["api_base"] = self.custom_endpoint or "http://localhost:11434"
