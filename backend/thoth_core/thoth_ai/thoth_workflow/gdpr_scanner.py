            ...
            for pattern in pattern_info['patterns']:
                if re.search(pattern, column_name):
                    matches.append({
                        ...
                        'score': calculate_sensitivity_score(pattern_info['sensitivity'])
                    })
...
def scan_database_for_gdpr(db_id: int) -> Dict[str, Any]:
    ...
    try:
        ...
        for category_group in GDPR_PATTERNS.keys():
            report['categories'][category_group] = {
                'count': 0,
                'columns': []
            }
        ...
        for table in tables:
            ...
            if table_analysis['has_sensitive_data']:
                ...
                report['summary']['sensitive_columns'] += table_analysis['sensitive_column_count']
