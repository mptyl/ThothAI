...
from thoth_core.models import SqlTable, SqlDb, SqlColumn, Workspace
...
from thoth_core.thoth_ai.thoth_workflow.async_table_comments import start_async_table_comments
...
class SqlTableAdmin(admin.ModelAdmin):
    ...
    def clean_invalid_pk_fk_fields(self, request, queryset):
        ...
        self.message_user(request, f"Cleaned {total_columns_updated} columns across {total_tables} tables.")
    
    clean_invalid_pk_fk_fields.short_description = "Clean invalid PK/FK fields in table columns"
