...
If you're setting up the Docker environment manually, first run the setup script:
...
This will create the required Docker network and volumes. Then start the services:
