...
def import_to_mariadb(db_name: str, tables_data: Dict[str, Tuple[List[str], List[Tuple]]], config: dict):
    """Import data to MariaDB"""
    print(f"  Importing to MariaDB...")
    ...
    try:
        ...
        cursor.close()
        conn.close()
        print(f"  MariaDB import completed")
        
    except Exception as e:
        print(f"  MariaDB import failed: {e}")

def import_to_mysql(db_name: str, tables_data: Dict[str, Tuple[List[str], List[Tuple]]], config: dict):
    """Import data to MySQL"""
    print(f"  Importing to MySQL...")
    ...
    try:
        ...
        cursor.close()
        conn.close()
        print(f"  MySQL import completed")
        
    except Exception as e:
        print(f"  MySQL import failed: {e}")

def import_to_postgres(db_name: str, tables_data: Dict[str, Tuple[List[str], List[Tuple]]], config: dict):
    """Import data to PostgreSQL"""
    print(f"  Importing to PostgreSQL...")
    ...
    try:
        ...
        cursor.close()
        conn.close()
        print(f"  PostgreSQL import completed")
        
    except Exception as e:
        print(f"  PostgreSQL import failed: {e}")

def import_to_sqlserver(db_name: str, tables_data: Dict[str, Tuple[List[str], List[Tuple]]], config: dict):
    """Import data to SQL Server"""
    print(f"  Importing to SQL Server...")
    ...
    try:
        ...
        cursor.close()
        conn.close()
        print(f"  SQL Server import completed")
        
    except Exception as e:
        print(f"  SQL Server import failed: {e}")

def import_to_oracle(db_name: str, tables_data: Dict[str, Tuple[List[str], List[Tuple]]], config: dict):
    """Import data to Oracle"""
    print(f"  Importing to Oracle...")
    
    try:
        # Oracle connection
        dsn = cx_Oracle.makedsn('localhost', config['servers']['oracle']['port'], service_name='XE')
        ...
        cursor.close()
        conn.close()
        print(f"  Oracle import completed")
        
    except Exception as e:
        print(f"  Oracle import failed: {e}")

def import_to_supabase(db_name: str, tables_data: Dict[str, Tuple[List[str], List[Tuple]]], config: dict):
    ...
    try:
        ...
        cursor.close()
        conn.close()
        print(f"  Supabase import completed")
...
def main():
    ...
    for db_name, db_config in config['databases'].items():
        ...
        print(f"  Found {len(tables)} tables with {sum(len(data[1]) for data in tables_data.values())} total rows")
...
if __name__ == "__main__":
    ...
    required_packages = ['mysql-connector-python', 'psycopg2-binary', 'pyodbc', 'cx_Oracle']
    missing_packages = []
