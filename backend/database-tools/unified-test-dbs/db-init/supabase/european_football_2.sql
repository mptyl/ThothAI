-- Supabase PostgreSQL schema for european_football_2 database
...
CREATE POLICY "Allow read access to Player_Attributes" ON Player_Attributes FOR SELECT USING (true);
...
CREATE POLICY "Allow read access to Player" ON Player FOR SELECT USING (true);
...
CREATE POLICY "Allow read access to League" ON League FOR SELECT USING (true);
...
CREATE POLICY "Allow read access to Country" ON Country FOR SELECT USING (true);
...
CREATE POLICY "Allow read access to Team" ON Team FOR SELECT USING (true);
...
ALTER TABLE Team_Attributes ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow read access to Team_Attributes" ON Team_Attributes FOR SELECT USING (true);
...
CREATE POLICY "Allow read access to Match" ON Match FOR SELECT USING (true);
