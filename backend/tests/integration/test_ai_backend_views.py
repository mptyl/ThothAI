...
class TestAIBackendViews(TestCase):
    ...
    def setUp(self):
        ...
        self.qdrant_patcher = patch(
            "thoth_ai_backend.vector_database_utils.QdrantClient"
        )
    ...
    def test_create_evidence_view(self):
        ...
        try:
            ...
            response = self.client.post(
                reverse("thoth_ai_backend:create_evidence"), evidence_data
            )
    ...
    def test_delete_evidence_execute_view(self):
        ...
        try:
            ...
            response = self.client.post(
                reverse(
                    "thoth_ai_backend:delete_evidence_confirmed", args=[evidence.id]
                )
            )
